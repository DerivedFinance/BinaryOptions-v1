...
export const truncateBalance = (balance, first = 8) =>
  balance ? `${balance.slice(0, first)}...` : null;

export const isValidDate = (timestamp) => new Date(timestamp).getTime() > 0;

export const formatTxTimestamp = (timestamp) =>
...
export const formatShortDateWithTime = (date) =>
